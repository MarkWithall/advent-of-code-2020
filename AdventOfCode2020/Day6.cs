...
{
    [TestFixture(TestName = "Day 6: Custom Customs")]
    public class Day6
    {
        [Test]
        public void Part1()
        {
            Assert.AreEqual(6768, SumOfUniqueQuestions(Day6Input));
        }
        ...
        private static readonly string[] Day6Input =
        {
