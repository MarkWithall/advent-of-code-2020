...
namespace AdventOfCode2020
{
    ...
    public sealed class Day17
    {
        ...
        public void Part1()
        {
            Assert.AreEqual(263, ActiveCubes(Day17Input, 6));
        }
        
        [Test]
        public void Part1Sample()
        {
            Assert.AreEqual(112, ActiveCubes(Day17SampleInput, 6));
        }

        private static long ActiveCubes(string[] input, long cycles)
        {
