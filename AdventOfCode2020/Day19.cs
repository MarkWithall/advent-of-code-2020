...
namespace AdventOfCode2020
{
    ...
    public sealed class Day19
    {
        ...
        public void Part1()
        {
            Assert.AreEqual(156, ValidCount(Day19Input));
        }

        [Test]
        public void Part1Sample()
        {
            Assert.AreEqual(2, ValidCount(Day19SampleInput));
        }
        ...
        {
            public bool Matches(string message) => Formats.Any(f => MatchesFormat(message, f));
            ...
            private bool MatchesFormat(string message, long[] format)
            {
                ...
                string? FindMatch(string m, IRule r)
                {
                    for (var i = 1; i <= m.Length; i++)
                    {
                        ...
                        {
                            Cache.Add((subMessage, r), true);
                            return subMessage;
                        }

                        Cache.Add((subMessage, r), false);
                    }
        ...
        private static readonly string[] Day19SampleInput =
        {
            "0: 4 1 5",
            "1: 2 3 | 3 2",
            "2: 4 4 | 5 5",
        ...
        private static readonly string[] Day19Input =
        {
            "62: 109 24 | 103 36",
            "9: 75 36 | 67 24",
            "66: 107 24 | 91 36",
