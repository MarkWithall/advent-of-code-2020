...
namespace AdventOfCode2020
{
    ...
    public sealed class Day12
    {
        ...
        public void Part1()
        {
            Assert.AreEqual(1603, ManhattenDistanceAfterNavigation(Day12Input));
        }
        ...
        private static int ManhattenDistanceAfterNavigation(string[] input)
        {
            var east = 0;
            var north = 0;
            var currentEastDirection = 1;
            var currentNorthDirection = 0;
            ...
            foreach (var instruction in input)
            {
                ...
                switch (action)
                {
                    ...
                    case 'L':
                    {
                        var currentDirection = (currentEastDirection, currentNorthDirection) switch
                        {
                            (0, 1) => 0,
                            (1, 0) => 90,
                            (0, -1) => 180,
                            (-1, 0) => 270,
                            _ => throw new InvalidOperationException("Not handled")
                        };
                        currentDirection = (currentDirection - value + 360) % 360;
                        (currentEastDirection, currentNorthDirection) = currentDirection switch
                        {
                            0 => (0, 1),
                            90 => (1, 0),
                            180 => (0, -1),
                    ...
                    case 'F':
                    {
                        east += currentEastDirection * value;
                        north += currentNorthDirection * value;
                        break;
                    }
                    default:
                    {
        ...
        private static readonly string[] Day12Input =
        {
            "W5",
            "F66",
            "S4",
